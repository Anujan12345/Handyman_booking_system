...
const Footer = () => {
  ...
  return (
    ...
    //       <p style={textStyle}>Email: handymanbookingsystem2024@gmail.com</p>
    //       <p style={textStyle}>Phone: +94-710130619</p>
    ...
    <div style={footerContentStyle}>
      <div style={sectionStyle}>
        ...
        <p style={textStyle}>
          Email: 
          <a href="mailto:handymanbookingsystem2024@gmail.com" style={textStyle}>
            handymanbookingsystem2024@gmail.com
          </a>
        </p>
        <p style={textStyle}>
          Phone: 
          <a href="tel:+94710130619" style={textStyle}>
            +94-710130619
          </a>
        </p>
        <p style={textStyle}>Address: Hapugala, Galle, Sri Lanka</p>
      ...
      <div style={sectionStyle}>
        ...
        <div style={socialLinksContainerStyle}>
          ...
          >
            <img
              src="https://th.bing.com/th/id/R.39550c155a7c7a519f31887edbb7d32c?rik=qvE8E9MyKGlnHw&pid=ImgRaw&r=0"
              alt="YouTube"
              style={iconStyle}
            />
          </a>
          ...
          >
            <img
              src="https://th.bing.com/th/id/OIP.yLZjN1KcU2UAnD8-h9F3PAHaHa?rs=1&pid=ImgDetMain"
              alt="Instagram"
              style={iconStyle}
            />
          </a>
    ...
    <div style={footerBottomStyle}>
      <p style={textStyle}>
        &copy; {new Date().getFullYear()} Handyman Booking System. All rights reserved.
      </p>
    </div>
  </footer>
