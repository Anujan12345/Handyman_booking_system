...
function Header() {
  ...
  return (
    <header className="bg-[#311583] shadow-sm h-auto justify-center">
      <div className="flex justify-between items-center max-w-9xl mx-auto p-4">
        <Link to="/">
          <h1 className="font-bold text-xl sm:text-3xl flex flex-wrap">
            <span className="text-white font-bold">Handyman Booking <span className="text-yellow-300"> System</span> </span>
        ...
        {user.username ? ( 
          ...
          <Link to="/signin">
            <button className="rounded-full bg-slate-700 hover:bg-slate-400 text-white hover:text-black font-bold py-2 px-4 ">
              Sign In
            </button>
          </Link>
          </>
