...
export default function ProviderRegister() {
  ...
  return (
    <div className="h-100 white bg-gray-300">
      <div className="container py-5 h-100 ">
        <div className="row d-flex justify-content-center align-items-center h-100 ">
          <div className="col ">
            <div className="card card-registration my-4 bg-[#156479]">
              <div className="card-body p-md-5 text-black">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="col-md-6 mb-4">
                      <div className="form-outline">
                        ...
                        <input
                          type="text"
                          id="form3Example1m"
                          className="form-control form-control-lg bg-slate-400"
                  ...
                  <div className="row ">
                    <div className="col-md-6 mb-4 ">
                      <select className="select text-white bg-slate-400 w-full h-10 rounded-lg" name="service" value={formData.service} onChange={handleChange}>
                    ...
                    <div className="col-md-6 mb-4">
                      <select className="select text-white bg-slate-400 w-full h-10 rounded-lg " name="city" value={formData.city} onChange={handleChange}>
